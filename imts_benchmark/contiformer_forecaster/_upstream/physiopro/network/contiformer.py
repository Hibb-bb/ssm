...
# Vendored adaptation: drop the `from .tsrnn import NETWORKS` import (it pulls
# in microsoft/utilsd registry framework). The downstream
# `@NETWORKS.register_module("contiformer")` decorator is also stripped — we
# instantiate ContiFormer directly from our adapter, no registry needed.
